...
-- Função para ajustar WalkSpeed para 35
local function adjustWalkSpeed(player)
    local humanoid = player.Character and player.Character:FindFirstChild("Humanoid")
    if humanoid then
        humanoid.WalkSpeed = 35
        print("WalkSpeed ajustado para 35")
    else
...
-- Teleportar personagem para a posição final
teleportCharacter(player, Vector3.new(-5, -5, 15))

-- Ajustando o WalkSpeed para 35 no final
